    ...
    _createClass(WithNaverEvents, [{
      ...
      value: function generateListenerNames() {
        this.listenerNames = this.props.naverEventNames.map(function (naverEventName) {
          ...
          var camelEventName = lodash.camelCase(naverEventName); // propsListener is event listener defined on props. (user input)

          var propsListenerName = lodash.camelCase("on_".concat(naverEventName)); // naverListener is naver kvo event listener defined and managed inside component.
      ...
      value: function updateListeners() {
        ...
        var orphanListenerNames = lodash.difference(beforeListenerNames, currentListenerNames); // log('orphanListenerNames', orphanListenerNames)
